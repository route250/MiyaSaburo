...
def neko_news():
    ...
    for d in Ite:
        ...
        while try_count <= try_max:
            ...
            base_article = bot.ChatCompletion(msg_hist, temperature=0.7)
...
#                     )
#                 break
#             except (openai.RateLimitError,openai.InternalServerError,openai.APIConnectionError) as ex:
#                 if retry>0:
#                     print( f"{ex}" )
#                     time.sleep(5)
#                 else:
...
#     except (openai.AuthenticationError,openai.BadRequestError) as ex:
#         print( f"{ex}" )
#         return None
#     except (openai.RateLimitError,openai.InternalServerError,openai.APIConnectionError) as ex:
#         print( f"{ex}" )
